CREATE DATABASE  IF NOT EXISTS `online_regist` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `online_regist`;
-- MySQL dump 10.13  Distrib 5.5.47, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: online_regist
-- ------------------------------------------------------
...
CREATE TABLE `disease` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `departmen_id` int(11) DEFAULT NULL,
  `name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `doctor` (
  ...
  `name` varchar(45) DEFAULT NULL,
  `doctor_desc` varchar(45) DEFAULT NULL,
  `doctorcol` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hospital` (
  ...
  `name` varchar(45) DEFAULT NULL,
  `hospital_desc` varchar(45) DEFAULT NULL,
  `image` varchar(45) DEFAULT NULL,
  `hospital_class` varchar(45) DEFAULT NULL,
...
INSERT INTO `user` VALUES (2,'haha','123456','1095409267@qq.com',''),(3,'test','testtest','18825077991@163.com','');
...
-- Dump completed on 2016-04-18 21:40:23
